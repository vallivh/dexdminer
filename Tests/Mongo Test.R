...
m <- mongo(url = "mongodb://127.0.0.1:27017/?gssapiServiceName=mongodb", 
...
qry1 <- m$find(qquery = '{"month":{ "$in": [1,2] }, "day":1, "carrier":"AA"}',
               fields = '{"year": true, "month": true, "day": true, "carrier": true}')
